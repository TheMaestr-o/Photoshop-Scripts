...
|--------|-----------|-------|
| Smart Path Crop | [smart-path-crop](https://github.com/TheMaestr-o/smart-path-crop) | [![Stars](https://img.shields.io/github/stars/TheMaestr-o/smart-path-crop?style=flat-square&label=stars)](https://github.com/TheMaestr-o/smart-path-crop/stargazers) |
| Layer Cleanup | [layer-cleanup](https://github.com/TheMaestr-o/layer-cleanup) | [![Stars](https://img.shields.io/github/stars/TheMaestr-o/layer-cleanup?style=flat-square&label=stars)](https://github.com/TheMaestr-o/layer-cleanup/stargazers) |
| PathTransfer | [path-transfer](https://github.com/TheMaestr-o/path-transfer) | [![Stars](https://img.shields.io/github/stars/TheMaestr-o/path-transfer?style=flat-square&label=stars)](https://github.com/TheMaestr-o/path-transfer/stargazers) |
| DocInfo Engine | [docinfo-engine](https://github.com/TheMaestr-o/docinfo-engine) | [![Stars](https://img.shields.io/github/stars/TheMaestr-o/docinfo-engine?style=flat-square&label=stars)](https://github.com/TheMaestr-o/docinfo-engine/stargazers) |
| Document Info Extractor | [document-info-extractor](https://github.com/TheMaestr-o/document-info-extractor) | [![Stars](https://img.shields.io/github/stars/TheMaestr-o/document-info-extractor?style=flat-square&label=stars)](https://github.com/TheMaestr-o/document-info-extractor/stargazers) |
| Stack in PSD | [stack-in-psd](https://github.com/TheMaestr-o/stack-in-psd) | [![Stars](https://img.shields.io/github/stars/TheMaestr-o/stack-in-psd?style=flat-square&label=stars)](https://github.com/TheMaestr-o/stack-in-psd/stargazers) |
